...
<body class="w-full px-20 py-8 bg-[#FEFDF8]">
    ...
    <main class="w-full flex items-center lg:items-start lg:flex-row flex-col gap-6 mt-10">
        <!-- Payment Methods -->
        <div class="w-3/4">
            <!-- Wrapper untuk keseluruhan pembayaran -->
            <div x-data="{ paymentMethod: 'credit' }" class="space-y-10">

                <!-- Metode Pembayaran -->
                <div class="flex flex-wrap md:flex-nowrap gap-4">
                    <!-- Credit Card -->
                    <div @click="paymentMethod = 'credit'"
                        ...
                        <img :src="paymentMethod === 'credit' ? '{{ asset('icon/creditActive.png') }}' :
                            '{{ asset('icon/credit.png') }}'"
                            alt="Credit Card" class="w-48 mb-4">
                        <span :class="paymentMethod === 'credit' ? 'text-white' : 'text-[#402F0B]'"
                            class="text-base font-semibold text-center">Credit Card</span>
                    </div>
                    ...
                    <div @click="paymentMethod = 'qris'"
                        ...
                        <img :src="paymentMethod === 'qris' ? '{{ asset('icon/qr-codeActive.png') }}' :
                            '{{ asset('icon/qr-code.png') }}'"
                            alt="QRIS" class="w-48 mb-4">
                        <span :class="paymentMethod === 'qris' ? 'text-white' : 'text-[#402F0B]'"
                            class="text-base font-semibold text-center">QRIS</span>
                    </div>
                    ...
                    <div @click="paymentMethod = 'cash'"
                        ...
                        class="flex flex-col items-center justify-center p-6 w-full rounded-xl shadow hover:shadow-lg cursor-pointer transition-all duration-200">
                        <img :src="paymentMethod === 'cash' ? '{{ asset('icon/cashActive.png') }}' :
                            '{{ asset('icon/cash.png') }}'"
                            alt="CASH" class="w-48 mb-4">
                        <span :class="paymentMethod === 'cash' ? 'text-white' : 'text-[#402F0B]'"
                            class="text-base font-semibold text-center">CASH</span>
                    </div>
                </div>
                    ...
                    <div x-data="{ selectedBank: '' }">
                        <div class="flex flex-wrap gap-4 mb-6">
                            ...
                            <label
                                ...
                                <input type="radio" name="bank" value="bni" class="form-radio text-[#402F0B]"
                            ...
                            <label
                                ...
                                <input type="radio" name="bank" value="bca" class="form-radio text-[#402F0B]"
                                    x-model="selectedBank">
                            ...
                            <label
                                ...
                                <input type="radio" name="bank" value="mandiri" class="form-radio text-[#402F0B]"
                                    x-model="selectedBank">
                            ...
                            <label
                                ...
                                <input type="radio" name="bank" value="bri" class="form-radio text-[#402F0B]"
                                    x-model="selectedBank">
            ...
            <div class="w-full">
                <div class=" min-h-96 bg-white rounded-2xl shadow-md shadow-neutral-300/40 px-6 pt-6 pb-12 text-sm">
                    ...
                    <div class="flex justify-between text-[#A19580] mb-2">
                        <span>Items</span>
                        <span class="text-[#402F0B] font-medium">4</span>
                    </div>
                    <div class="flex justify-between text-[#A19580] mb-2">
                        <span>Sub Total</span>
                        <span class="text-[#402F0B] font-semibold">Rp 100.000</span>
                    </div>
                    <div class="flex justify-between text-[#A19580] mb-2">
                        <span>Shipping</span>
                    ...
                    <button onclick="location.href = '/menu/payment-method/success'"
